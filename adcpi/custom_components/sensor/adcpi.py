...
DEFAULT_I2C_ADD1 = '0x68'
DEFAULT_I2C_ADD2 = '0x69'
DEFAULT_BITRATE = 18
DEFAULT_PGA = 1
...
PLATFORM_SCHEMA = PLATFORM_SCHEMA.extend({
    ...
    vol.Optional(CONF_I2C_ADDRESS1, default=DEFAULT_I2C_ADD1): vol.Coerce(int),
    vol.Optional(CONF_I2C_ADDRESS2, default=DEFAULT_I2C_ADD2): vol.Coerce(int),
